...
const features = [
  {
    ...
    testimonial: {
      quote: "Missed a $680K offer because my old ISA didn't answer a Zillow lead for three hours. Swapped the next day. First month I booked 14 showings off leads I would've missed and closed three.",
      author: "Sarah Morales",
      role: "Team Lead, Keller Williams Phoenix",
      rating: 5,
    },
  },
  {
    ...
    testimonial: {
      quote: "Ran Ylopo for a year, then Structurely for six months. Both dropped leads into a black hole. Switched in November and my open houses went from four walk-ins to needing a sign-in sheet.",
      author: "David Li",
