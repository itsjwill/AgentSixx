...
const plans = [
  {
    ...
    features: [
      ...
      { name: "Email", value: "3,000/mo", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Email", value: "7,000/mo", included: true },
      { name: "Compliance Stack", value: "8-layer", included: true },
      { name: "CRM Integrations", value: "Unlimited", included: true },
      { name: "Seller Data Sourcing", value: "1,100/mo, 5 zips", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Email", value: "15,000/mo", included: true },
      { name: "Compliance Stack", value: "8-layer", included: true },
      { name: "CRM Integrations", value: "Unlimited", included: true },
      { name: "Seller Data Sourcing", value: "2,500/mo + territory-exclusive", included: true },
...
const dataTiers = [
  ...
  },
  {
    ...
    description: "Lock down your territory. Exclusive zip codes. 2,500 records/month. First-look on every new seller lead before it hits the shared pool.",
    features: [
      "2,500 seller records / month",
