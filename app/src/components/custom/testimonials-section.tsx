...
const testimonials = [
  ...
  },
  {
    ...
    video: true,
    rating: 5,
    quote: "The Intelligent Voice is so natural that leads don't even realize they're talking to a bot. I've closed 4 extra deals this quarter.",
    metrics: { appointments: 18, responseTime: "5 sec", roi: "15x" },
    tag: "Intelligent Voice",
  },
  {
    id: 3,
